        ...
        <div class="drop">
          <div class="contentBox">
            ...
            <form>
              ...
              <div class="inputBox">
                <input type="reset" value="Login" @click="clickLogin" />
              </div>
            </form>
          </div>
        </div>
        <div class="btns" @click="toReg">
          <span>注册</span>
        </div>
...
const clickLogin = async () => {
  ...
  if (!!token_info) {
    ...
    User.changeAdmin(token_info.username == "admin");
    window.sessionStorage.setItem("username", token_info.username);
    // document.cookie = "token=" + token_info.token;

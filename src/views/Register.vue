        ...
        <div class="drop">
          <div class="contentBox">
            ...
            <form>
              ...
              <div class="inputBox">
                <input type="reset" value="Register" @click="clickRegister" />
              </div>
            </form>
          </div>
        </div>
        <div class="btns" @click="toLogin">
          <span>登陆</span>
        </div>
...
const clickRegister = async () => {
  await IReg(username.value, password.value).then(() => {
